...
%TODO mostrar pseudocodigo del user_init.cpp. pseudo:user_init.
...
Adicionalmente se establece %TODO decir lo del baudrate%. por medio de una función propia del SDK utilizado para el desarrollo.
...
%TODO mostrar init( ). pseudo:settings_init.
...
Para lograr eso, dentro del método init( ) también se inicializa el pin que se va a utilizar como reset (pin %TODO agregar pin%) y se establece el callback para cuando dicho evento ocurra.
...
%TODO mostrar loadSettings( ). pseudo:settings_loadSettings.
...
%TODO mostrar storeSettings( ). pseudo:settings_storeSettings.
...
%TODO mostrar init( ). pseudo:wifiManager_init.
...
%TODO mostrar pseudocódigo del método init( ). pseudo:server_init.
...
%TODO mostrar pseudocódigo del método listen( ). pseudo:server_listen.
...
%TODO mostrar pseudocódigo del método send( ). pseudo:server_send.
...
%TODO mostrar pseudocódigo del método receiveCallback( ). pseudo:server_receive_callback.
...
En la figura \ref{pseudo:messageHandler_handle} se muestra un pseudocódigo del método a fin de brindar mayor claridad en la comprensión de la función.

%TODO mostrar pseudocódigo del método handle( ). pseudo:messageHandler_handle.
...
%TODO mostrar pseudocódigo del método init( ). pseudo:ledSign_init.
...
%TODO mostrar pseudocódigo del método messageChanged(). pseudo:ledSign_messageChanged.
...
El segundo parámetro es brate, es un entero positivo que indica la velocidad de parpadeo que posee el texto.
En caso de que no se requiera se debe colocar un 0.

El último parámetro es srate que también es un entero que indica la velocidad a la que se desplaza el contenido.
