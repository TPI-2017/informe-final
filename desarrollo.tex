...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.3\linewidth]{imagenes/uml/settings.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.4\linewidth]{imagenes/uml/server.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.5\linewidth]{imagenes/uml/LEDSign.pdf}
