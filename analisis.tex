...
En paralelo con la elección de los componentes, se decide realizar el modelo de la solución general del sistema del lado del software, al cual se le asignó tres semanas. Esta etapa incluye tanto la investigación de las tecnologías de desarrollo compatibles con los distintos microcontroladores de la industria, así como también, la elección del lenguaje de programación, frameworks, confeccionado de UMLs y diagramas de estados.
...
Al finalizar el proceso de implementación del protocolo, se decidió a realizar en paralelo el desarrollo de la aplicación de PC y del firmware del microcontrolador. Para cada tareá se asignó dos y cuatro semanas respectivamente.
En esta última fase se incluye la codificación de las conexiones TLS entre los dos módulos de software.

Tras concluir con las dos aplicaciones de software, se destinó una semana a la prueba en conjunto de estos dos productos.
...
A continuación, se estimó dos semanas adicionales para el proceso de soldado de los componentes hacia la plaqueta y el testo de continuidad eléctrica entre los módulos de hardware.

Finalmente, tras haber realizado la prueba general del software, se utilzia la última semana de producción para hacer pruebas generales donde se evalúa la interacción de los programas con el cartel propiamente dicho.
