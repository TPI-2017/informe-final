...
Tras haber realizado ésto durante unos 10 a 15 minutos (el tiempo puede variar según el calor de la plancha y la calidad del papel), debe retirarse la plancha, desconectar su cable de alimentación y sumergir en un recipiente con agua fría la placa con la hoja, que en este punto estará adherida a la misma.
...
Para reducir el cobre se deberán utilizar guantes de latex durante todo el proceso ya que el cloruro férrico es un químico que debe ser manipulado con extremo cuidado. 
