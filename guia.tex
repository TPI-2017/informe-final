...
%TODO poner todo sobre la conexión de los cables, el enchufar etc _en imperativo_

\subsubsection{Configuración de jumpers}
...
%		Jumpers de cantidad de letras		& 3              & En total son tres. Antes de encender de debe seleccionar la cantidad de módulos esclavos que serán utilizados. \\ \hline
%	\end{tabular}
%\end{table}
%