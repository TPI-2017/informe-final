...
\begin{table}[ht!]
	...
	\begin{tabular}{lcp{.5\textwidth}}
		\multicolumn{1}{c}{Elemento}	& Identificación & \multicolumn{1}{c}{Descripción} \\ \hline
		...
		Jumpers de cantidad de letras	& 3              & En total son tres. Antes de encender se debe seleccionar la cantidad de módulos esclavos que serán utilizados. \\ \hline
		Cables de interfaz 				& 4				 & Son cinco cables en que conecta: GND, VCC, DATAIN, CLK y LOAD, entre módulo maestro-esclavo o esclavo-esclavo.
	\end{tabular}
\end{table}
...
Y además, conectar por cada esclavo su matriz de LEDs correspondiente usando de guía la figura \ref{fig:matriz-esclavo}.
